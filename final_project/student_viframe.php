...
$query = $conn->query("select * from FirstSubject where level='$level'");
if (!$query) {
    die("error");
}
?>
    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                ...
                <center>
                    <h3 class="tab"> Lesson Content </h3>
                </center>
                ...
                <div class="embed-responsive embed-responsive-21by9">
                    <iframe class="embed-responsive-item" src="<?=$event['first_url']?>" width="560" height="">
                    </iframe>
                </div>
                <div> </div> <br> <br>
