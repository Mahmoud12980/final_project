...
$sql = "SELECT * FROM attendance where level =2";
if ($result = mysqli_query($link, $sql)) {
    if (mysqli_num_rows($result) > 0) {
        echo "<div class='container'>";
        echo "<table class='alt'>";
        echo "<tr>";
        echo "<th class='cen'>Name </th>";
        echo "<th class='cen'>Level </th>";
        echo "</tr>";
        ...
        echo "No Attendance in this level";
    }
} else {
