...
$sql = "SELECT * FROM files where level='$level'";
                ...
                <div class="table-wrapper">
                    <table id="table">
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $file['dr_name']; ?></td>
                                <td><?php echo $file['vtitle']; ?></td>
                                <td><?php echo $file['S_title']; ?></td>
                                <td><a href="download.php?file_id=<?php echo $file['id'] ?>"
                                        class="button primary">Download</a></td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
